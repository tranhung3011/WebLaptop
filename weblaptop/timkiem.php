...
<script src="js/jquery-3.1.0.js"></script>
  <main>
    ...
    <div class="container">       
        ...
        $tk=$_POST['timkiem'];
        $sql="select ma_sp from sanpham_tbl where tieude like N'%$tk%' or nsx like N'%$tk%' or thongso like N'%$tk%' or ma_sp like N'%$tk%' or ten_sp like N'%$tk%'";
        ...
        <?php }else {
            foreach($data as $v)
            {
                $sql1="select * from  sanpham_tbl where ma_sp='$v[ma_sp]'";
                ...
                {?>
                    <div class="card1">
                        <a href="#">
                            ...
                            <h3 class="titlesp"><?php echo $row['ten_sp'] ?>  </h3>
